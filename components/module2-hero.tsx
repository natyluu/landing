...
export default function Module2Hero() {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <nav className="flex items-center gap-2 text-sm text-gray-400 mb-8">
            ...
            <span>/</span>
            <span className="text-white">Módulo 2</span>
          </nav>

          <div className="flex items-center gap-4 mb-6">
            <span className="bg-purple-600 text-white px-4 py-2 rounded-full text-sm font-medium">Módulo 2</span>
            <span className="bg-green-600 text-white px-3 py-1 rounded text-xs font-medium">10 min</span>
          </div>
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl">
            En este módulo descubrirás cómo usar tu asistente artificial para crear estrategias de trading completas. No
            hablamos solo de análisis, sino de planes operativos con niveles precisos de entrada, take profit y stop
            loss, generados por prompts bien estructurados.
          </p>
